...
namespace Stupid {
    ...
    public partial struct Vector3 : IEquatable<Vector3>, IFormattable {
        ...
        public static Vector3 SmoothDamp(Vector3 current, Vector3 target, ref Vector3 currentVelocity, float smoothTime, float maxSpeed, float deltaTime) {
            ...
            smoothTime = Moths.Max(0.0001F, smoothTime);
        ...
        // Creates a new vector with given x, y components and sets /z/ to zero.
        public Vector3(Vector2 vector) { this.x = vector.x; this.y = vector.y; z = 0f; }
        ...
        public static float Angle(Vector3 from, Vector3 to) {
            ...
            float dot = Moths.Clamp(Dot(from, to) / denominator, -1F, 1F);
            return ((float)Math.Acos(dot)) * Moths.Rad2Deg;
        }
        ...
        public static float SignedAngle(Vector3 from, Vector3 to, Vector3 axis) {
            ...
            float sign = Moths.Sign(axis.x * cross_x + axis.y * cross_y + axis.z * cross_z);
        ...
        public static Vector3 Min(Vector3 lhs, Vector3 rhs) {
            return new Vector3(Moths.Min(lhs.x, rhs.x), Moths.Min(lhs.y, rhs.y), Moths.Min(lhs.z, rhs.z));
        }

        // Returns a vector that is made from the largest components of two vectors.
        public static Vector3 Max(Vector3 lhs, Vector3 rhs) {
            return new Vector3(Moths.Max(lhs.x, rhs.x), Moths.Max(lhs.y, rhs.y), Moths.Max(lhs.z, rhs.z));
        }
