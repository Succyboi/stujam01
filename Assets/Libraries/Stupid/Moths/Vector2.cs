...
namespace Stupid {
    ...
    public partial struct Vector2 : IEquatable<Vector2>, IFormattable {
        ...
        public static float SignedAngle(Vector2 from, Vector2 to) {
            ...
            float sign = Moths.Sign(from.x * to.y - from.y * to.x);
        ...
        public static Vector2 Min(Vector2 lhs, Vector2 rhs) { return new Vector2(Moths.Min(lhs.x, rhs.x), Moths.Min(lhs.y, rhs.y)); }

        // Returns a vector that is made from the largest components of two vectors.
        
        public static Vector2 Max(Vector2 lhs, Vector2 rhs) { return new Vector2(Moths.Max(lhs.x, rhs.x), Moths.Max(lhs.y, rhs.y)); }
