...
namespace Stupid {
    ...
    public partial struct Vector2Int : IEquatable<Vector2Int>, IFormattable {
        ...
        public float magnitude {  get { return Moths.Sqrt((float)(x * x + y * y)); } }
        ...
        public static Vector2Int Min(Vector2Int lhs, Vector2Int rhs) { return new Vector2Int(Moths.Min(lhs.x, rhs.x), Moths.Min(lhs.y, rhs.y)); }

        // Returns a vector that is made from the largest components of two vectors.
        
        public static Vector2Int Max(Vector2Int lhs, Vector2Int rhs) { return new Vector2Int(Moths.Max(lhs.x, rhs.x), Moths.Max(lhs.y, rhs.y)); }
